...
exports.sourceNodes = (
  { actions, createContentDigest },
  {
    ...
    location = `Germany`,
    socialMedia = [
      { title: `LinkedIn`, href: `https://www.linkedin.com/in/yohannpereira28/` },
      { title: `GitHub`, href: `https://github.com/yopereir` },
    ],
...
exports.createPages = async ({ actions, graphql, reporter }, themeOptions) => {
  ...
  let paginationprojects = [];
  result.data.site.siteMetadata.categoriesToShow.forEach((category)=>{paginationprojects = paginationprojects.concat(getProjectsInCategory(category, projects))})

  projects.forEach((project, index) => {
    const { fileAbsolutePath } = project.parent

    const next = paginationprojects.indexOf(project) === 0 ? null : paginationprojects[index - 1]
    const prev = paginationprojects.indexOf(project) === paginationprojects.length - 1 ? null : paginationprojects[index + 1]
