...
//{categoriesToShow.length == 1?<a href={"resumes/Resume_"+categoriesToShow[0].replace(" ","-")+".docx"} target="_blank"><button value="Send Email" style={{"maxWidth":"25vw"}} className="btn-lrg submit-btn">Download CV</button></a>:<a href={"resumes/Resume_PM.docx"} target="_blank"><button value="Send Email" style={{"maxWidth":"25vw"}} className="btn-lrg submit-btn">Download CV</button></a>}
